...
def rmsnorm(
    ...
    torch.ops.tf_kernel.rmsnorm.default(out, input, weight, eps, enable_pdl)
    return out
...
def fused_add_rmsnorm(
    ...
    if enable_pdl is None:
        enable_pdl = is_arch_support_pdl()
    torch.ops.tf_kernel.fused_add_rmsnorm.default(
...
def gemma_rmsnorm(
    ...
    if enable_pdl is None:
        enable_pdl = is_arch_support_pdl()
    torch.ops.tf_kernel.gemma_rmsnorm.default(out, input, weight, eps, enable_pdl)
    return out
...
def silu_and_mul(input: torch.Tensor, out: torch.Tensor = None) -> torch.Tensor:
    ...
    torch.ops.tf_kernel.silu_and_mul.default(out, input)
    return out
...
def gelu_tanh_and_mul(input: torch.Tensor, out: torch.Tensor = None) -> torch.Tensor:
    ...
    torch.ops.tf_kernel.gelu_tanh_and_mul.default(out, input)
    return out
...
def gelu_and_mul(input: torch.Tensor, out: torch.Tensor = None) -> torch.Tensor:
    ...
    torch.ops.tf_kernel.gelu_and_mul.default(out, input)
    return out
...
if torch.version.hip is not None:
    ...
    def gelu_quick(input: torch.Tensor, out: torch.Tensor = None) -> torch.Tensor:
        ...
        torch.ops.tf_kernel.gelu_quick(out, input)
        return out
...
def apply_rope_with_cos_sin_cache_inplace(
    ...
    This is designed to be compatible with the TF/vLLM implementation.
    ...
    torch.ops.tf_kernel.apply_rope_pos_ids_cos_sin_cache.default(
...
def rotary_embedding(
    ...
    torch.ops.tf_kernel.rotary_embedding.default(
