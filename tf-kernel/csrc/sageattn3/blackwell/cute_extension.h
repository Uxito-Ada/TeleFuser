...
struct SM120_16x32x64_TN_VS_NVFP4 {
  ...
  fma(float& d0,
    ...
    CUTE_INVALID_CONTROL_PATH(
        "Attempting to use SM120::BLOCKSCALED::SM120_16x8x64_TN_VS without CUTE_ARCH_MXF4NVF4_4X_UE4M3_MMA_ENABLED");
#endif
  }
};
...
struct MMA_Traits<SM120::BLOCKSCALED::SM120_16x32x64_TN_VS_NVFP4> {
  ...
  // (T32,V32) -> (M16,K64)
  using ALayout = Layout<Shape<Shape<_4, _8>, Shape<_8, _2, _2>>, Stride<Stride<_128, _1>, Stride<_16, _8, _512>>>;
  // (T32,V64) -> (N32,K64)
  using BLayout = Layout<Shape<Shape<_4, _8>, Shape<_8, _2, _4>>, Stride<Stride<_256, _1>, Stride<_32, _1024, _8>>>;
  // (T32,V64) -> (M16,K64)
  ...
  // (T32,V16) -> (M16,N32)
  using CLayout =
      Layout<Shape<Shape<_4, _8>, Shape<Shape<_2, _4>, _2>>, Stride<Stride<_32, _1>, Stride<Stride<_16, _128>, _8>>>;
};
...
CUTE_HOST_DEVICE constexpr auto get_layoutSFA_TV(TiledMma& mma) {
  ...
  auto atile = make_tile(
      _,
      make_tile(
          make_layout(make_shape(size<1>(thr_layout_vmnk), size<2>(thr_layout_vmnk)), make_stride(Int<1>{}, Int<0>{})),
          _));
...
CUTE_HOST_DEVICE constexpr auto get_layoutSFB_TV(TiledMma& mma) {
  ...
  auto btile = make_tile(
      _,
      make_tile(
          make_layout(make_shape(size<1>(thr_layout_vmnk), size<2>(thr_layout_vmnk)), make_stride(Int<0>{}, Int<1>{})),
          _));
