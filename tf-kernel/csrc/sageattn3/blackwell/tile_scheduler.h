...
class StaticPersistentTileSchedulerOld {
 ...
 public:
  CUTLASS_DEVICE explicit StaticPersistentTileSchedulerOld(
      cutlass::FastDivmod const& m_block_divmod_, cutlass::FastDivmod const& head_divmod_, int const total_blocks_)
...
class SingleTileScheduler {
 public:
  ...
  struct WorkTileInfo {
    ...
    CUTLASS_DEVICE
    WorkTileInfo get_next_work(Params const& params) const {
      return {-1, -1, -1, false};
    }
  };
