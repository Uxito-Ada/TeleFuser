...
struct CollectiveEpilogueFwd {
  ...
  static Params to_underlying_arguments(Arguments const& args) {
    ...
    TMA_O tma_store_O =
        make_tma_copy(GmemTiledCopyOTMA{}, mO, SmemLayoutO{}, select<0, 2>(TileShape_MNK{}), _1{});  // no mcast for O
  ...
  CUTLASS_DEVICE void
  mma_store(SharedStorage& shared_storage, TiledMma tiled_mma, FrgTensorO const& tOrO, int thread_idx) {
  ...
  CUTLASS_DEVICE void
  store_zero(Params const& epilogue_params, int thread_idx, cute::tuple<int32_t, int32_t, int32_t> const& block_coord) {
