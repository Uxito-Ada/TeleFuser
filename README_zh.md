...
- ✨ **2026-07-19**：新增基于 actor 的流式 Pipeline 调度器，支持有界 backpressure、session 指标、actor-owned 确定性清理和 LingBot VAE 独立卡位。详见 [docs/zh/stream_scheduler.md](docs/zh/stream_scheduler.md)。
...
| Pipeline | 任务 | 说明 |
|----------|------|------|
| `LingBot-World v2` | 双向世界模型流式推理 | 交互式 WebRTC 控制闭环，见 [examples/lingbot/lingbot_world_v2_image_to_video_h100.py](examples/lingbot/lingbot_world_v2_image_to_video_h100.py) |
