...
Usage:
    python wan22_14b_image_to_video_cache_calibrate.py \
...
def main(
    ...
    """Run cache calibration for Wan2.2 14B Image-to-Video model."""
    logger.info("=" * 60)
    logger.info("Cache Calibrator for Wan2.2 14B Image-to-Video")
    logger.info("=" * 60)
