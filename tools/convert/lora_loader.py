...
class LoRAPatternDefinition:
    ...
    def get_base_key(self, key: str, detected_suffix: str) -> str | None:
...
class LoRAPatternMatcher:
    ...
    def detect_format(self, key: str, lora_weights: dict) -> tuple[LoRAFormat, str] | None:
        """
